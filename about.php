        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <p class="text-center">
                    ...
                    Twitter Bootstrap, NetBeans IDE, w3schools and StackOverflow.
                </p>
                <p class="text-center">
                    Please look up these tools if you want to learn web development.</p>
                <p class="text-center"> Thanks to them the job was very easy.
                </p>  
            </div>
        </div>
    </div>
